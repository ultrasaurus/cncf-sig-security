...
on a solution, bring the issue up for discussion. The following guidance shows a common steps, where communication often happens in different sequence. The
...
might share insights (via invited presentation) or wish to get involved.
  ...
  the problem and have feedback on your proposed solution or activity.
   ...
   B) Find a meeting where you or another group member who is interested in working on the project is able to attend, then add the issue to a meeting
   agenda: include a link and the name of the person who will present the
   proposal in the ["Planned Meeting" area of the meeting notes][meetings].
   Then at the meeting:
...
[meetings]: https://github.com/cncf/tag-security#meeting-times